...
const helpBoard = (_props: { command: string; params: string[] }) => (
                ...
                Object.entries(commandMap).map(([command, props]) => (
                    ...
                    <Box paddingLeft={2}>
                        <Text bold color="blue">
                            └ rippu {command}{
                                "options" in props && props.options && Object.keys(props.options).length > 0 ? " <options>" : ""
                            }
                        </Text>
                        <Text>
                            {" "}- {props.message}
                    ...
                    {
                        "options" in props && props.options && Object.entries(props.options).map(([option, description]) => (
                            <Box key={option} paddingLeft={15 + command.length}>
